...
void welcome()
{
	...
	drawString(35.5, 80, 0, GLUT_BITMAP_TIMES_ROMAN_24, ((char*)"SIMPLE AIRPLANE GAME "));
	glPopMatrix();
	glColor3f(0.137, 0.137, 0.556);
...
void display()
{
	...
	else if (instflag == true)
	{
		...
		drawString(33, 27, 0, GLUT_BITMAP_HELVETICA_18, ((char*)" ENJOY !!"));
	...
	else if (pause == true)
	{
		...
		glPopMatrix();
		glColor3f(0.137, 0.137, 0.556);
		drawString(40, 55, 0, GLUT_BITMAP_HELVETICA_18, ((char*)" GAME PAUSED"));
		drawString(37, 45, 0, GLUT_BITMAP_HELVETICA_18, ((char*)" PRESS 'P' to continue"));
		glutPostRedisplay();
